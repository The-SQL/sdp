...
} from "@/utils/db/suggested-edits"; // Adjust path as needed
import { createClient } from "@/utils/supabase/client";
import { SuggestedChange, SuggestedChangeStatus ,SuggestedChangePayload} from "@/utils/types"; // Adjust path as needed
...
const mockEdit: SuggestedChange = {
    ...
    payload: {
        ...
        units: [],
        lessons: [],
    } as unknown as SuggestedChangePayload,
    status: "pending",
...
    // Act
    const result = await getCourseSuggestedEdits("course1");
