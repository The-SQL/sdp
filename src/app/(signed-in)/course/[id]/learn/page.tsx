...
import { MCQExercise, FillBlankExercise, VideoPlayer, AudioPlayer } from '@/components/learn/components';
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            >
                              {isCompleted ? (
                                <CheckCircle  data-testid={`check-circle-${lesson.id}`} className="h-4 w-4 sm:h-5 sm:w-5 text-green-600 hover:text-green-700" />
                              ) : (
                                <Circle  data-testid={`circle-${lesson.id}`} className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 hover:text-gray-600" />
                              )}
                            </div>
